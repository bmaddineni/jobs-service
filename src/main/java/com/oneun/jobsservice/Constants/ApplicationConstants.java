package com.oneun.jobsservice.Constants;
...
public class ApplicationConstants {
    ...
    public static final String UNDP_POSTING_LINK_URL_PREFIX = "https://jobs.undp.org/";
    ...
    public static final String UNS_FIELD_DEADLINE_DATE_KEY = "Deadline";

    public static final String UNS_FIELD_JOB_FAMILY_KEY = "Job Family";
    public static final String UNS_FIELD_LEVEL_KEY = "Level";
    public static final String UNS_FIELD_POSTED_DATE_KEY = "Posted Date";
    public static final String UNS_FIELD_JOB_TITLE_KEY = "Job Title";

    public static final String UNS_FIELD_JOB_NETWORK_KEY = "Job Network";
    ...
    public static final String UNICEF_POSTING_LINK_URL_PREFIX_FOR_JOB_ID = "https://jobs.unicef.org/en-us/job/";
